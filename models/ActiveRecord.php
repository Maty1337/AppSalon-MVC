...
class ActiveRecord
{
    ...
    {
        $atributos  = $this->atributos(); // usa static::$columnasDB sin 'id'
        $sanitizado = [];
        foreach ($atributos as $key => $value) {
            if (is_null($value)) {
                $sanitizado[$key] = null; // se escribirá como NULL (sin comillas)
            } else {
                if (is_string($value)) $value = trim($value); // ← clave: elimina espacios al inicio/fin
